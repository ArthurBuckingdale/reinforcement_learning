...
criticOpts = rlRepresentationOptions('LearnRate',1e-3,'UseDevice','gpu');
...
actorOptions = rlRepresentationOptions('LearnRate',1e-3,'UseDevice','gpu');
...
opt = rlPPOAgentOptions('ExperienceHorizon',2400,...
                        'ClipFactor',0.1,...
...
trainOpts = rlTrainingOptions(...
    ...
    'UseParallel',true)
trainOpts.ParallelizationOptions.StepsUntilDataIsSent=2400;
